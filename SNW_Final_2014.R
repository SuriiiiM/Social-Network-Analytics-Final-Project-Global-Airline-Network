...
#network graph
AirportG <- graph.data.frame(t2,directed=FALSE)
AirportG <- simplify(AirportG)
plot.igraph(AirportG,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.05,edge.curved=FALSE)

CityG <- graph.data.frame(na.omit(t3),directed=FALSE)
CityG <- simplify(CityG)
plot.igraph(CityG,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

CountryG <- graph.data.frame(na.omit(t4),directed=FALSE)
CountryG <- simplify(CountryG)
plot.igraph(CountryG,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

IntG <- graph.data.frame(na.omit(t5),directed=FALSE)
IntG <- simplify(IntG)
plot.igraph(IntG,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)
...
#city level
unique(datac$continent_S) #"Africa" "Europe" "Asia" "Americas" "Oceania"
AsiaG1 <- graph.data.frame(datac[which(datac$continent_S=="Asia"&datac$continent_D=="Asia"),c(6,12)],directed=FALSE)
plot.igraph(AsiaG1,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

AfrG1 <- graph.data.frame(datac[which(datac$continent_S=="Africa"&datac$continent_D=="Africa"),c(6,12)],directed=FALSE)
plot.igraph(AfrG1,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

EuG1 <- graph.data.frame(datac[which(datac$continent_S=="Europe"&datac$continent_D=="Europe"),c(6,12)],directed=FALSE)
plot.igraph(EuG1,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

AmG1 <- graph.data.frame(datac[which(datac$continent_S=="Americas"&datac$continent_D=="Americas"),c(6,12)],directed=FALSE)
plot.igraph(AmG1,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

OcG1 <- graph.data.frame(datac[which(datac$continent_S=="Oceania"&datac$continent_D=="Oceania"),c(6,12)],directed=FALSE)
plot.igraph(OcG1,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)


#Country level
AsiaG2 <- graph.data.frame(datac[which(datac$continent_S=="Asia"&datac$continent_D=="Asia"),c(7,13)],directed=FALSE)
plot.igraph(AsiaG2,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

AfrG2 <- graph.data.frame(datac[which(datac$continent_S=="Africa"&datac$continent_D=="Africa"),c(7,13)],directed=FALSE)
plot.igraph(AfrG2,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

EuG2 <- graph.data.frame(datac[which(datac$continent_S=="Europe"&datac$continent_D=="Europe"),c(7,13)],directed=FALSE)
plot.igraph(EuG2,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

AmG2 <- graph.data.frame(datac[which(datac$continent_S=="Americas"&datac$continent_D=="Americas"),c(7,13)],directed=FALSE)
plot.igraph(AmG2,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

OcG2 <- graph.data.frame(datac[which(datac$continent_S=="Oceania"&datac$continent_D=="Oceania"),c(7,13)],directed=FALSE)
plot.igraph(OcG2,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)


#Internal Country level
AsiaG3 <- graph.data.frame(datac[which(datac$continent_S=="Asia"&datac$continent_D=="Asia"&datac$Country_S!=datac$Country_D),c(7,13)],directed=FALSE)
plot.igraph(AsiaG3,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

AfrG3 <- graph.data.frame(datac[which(datac$continent_S=="Africa"&datac$continent_D=="Africa"&datac$Country_S!=datac$Country_D),c(7,13)],directed=FALSE)
plot.igraph(AfrG3,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

EuG3 <- graph.data.frame(datac[which(datac$continent_S=="Europe"&datac$continent_D=="Europe"&datac$Country_S!=datac$Country_D),c(7,13)],directed=FALSE)
plot.igraph(EuG3,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

AmG3 <- graph.data.frame(datac[which(datac$continent_S=="Americas"&datac$continent_D=="Americas"&datac$Country_S!=datac$Country_D),c(7,13)],directed=FALSE)
plot.igraph(AmG3,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)

OcG3 <- graph.data.frame(datac[which(datac$continent_S=="Oceania"&datac$continent_D=="Oceania"&datac$Country_S!=datac$Country_D),c(7,13)],directed=FALSE)
plot.igraph(OcG3,vertex.label.color="black",vertex.size=5,edge.arrow.size=0.02,label.cex=0.02,edge.curved=FALSE)
...
a11 <- as.data.frame(authority_score(AirportG1)$vector)
h11 <- as.data.frame(hub_score(AirportG1)$vector)
r11 <- cbind(a11,h11) %>% rownames_to_column("Node")
colnames(r11) <- c("Node","authority","hub_score")
write_xlsx(r11, path = "airport_ah.xlsx", col_names = TRUE)
...
a21 <- as.data.frame(authority_score(CityG1)$vector)
h21 <- as.data.frame(hub_score(CityG1)$vector)
r21 <- cbind(a21,h21) %>% rownames_to_column("Node")
colnames(r21) <- c("Node","authority","hub_score")
write_xlsx(r21, path = "city_ah.xlsx", col_names = TRUE)
...
a31 <- as.data.frame(authority_score(CountryG1)$vector)
h31 <- as.data.frame(hub_score(CountryG1)$vector)
r31 <- cbind(a31,h31) %>% rownames_to_column("Node")
colnames(r31) <- c("Node","authority","hub_score")
write_xlsx(r31, path = "country_ah.xlsx", col_names = TRUE)
...
a41 <- as.data.frame(authority_score(IntG1)$vector)
h41 <- as.data.frame(hub_score(IntG1)$vector)
r41 <- cbind(a41,h41) %>% rownames_to_column("Node")
colnames(r41) <- c("Node","authority","hub_score")
write_xlsx(r41, path = "international_ah.xlsx", col_names = TRUE)


# network-level measure 
#Airport Level
centr_clo(AirportG,normalized=TRUE)$centralization #0.0008350746
#undirected #0.002060652
...
#####
#regression 2 edge level

data11 <- t4
data12 <- countrywhole2014[,c(1:9,14:21)]

g11 <- graph.data.frame(data11,directed=FALSE)
g11 <- simplify(g11)
g12 <- get.data.frame(g11)

g121 <- data.frame(g12$c2,g12$c1,g12$edges)
colnames(g12) <- c("c1","c2","edges")
colnames(g121) <- c("c1","c2","edges")

g122 <- unique(rbind(g12,g121))

g13 <- merge(g122,data12,by.x = "c1",by.y="Node")
g14 <- merge(g13,data12,by.x = "c2",by.y="Node")

summary(glm(edges~.,data=g14[,c(3,5,7:11,13:19,21,23:27,29:35)]))
